...
class TrackerEntry {
    ...
    static private Location lastPosition;
    ...
    static final String[] ATTRIBUTES = {
            ...
            ALTITUDE, SPEED, BEARING, DIST_NET_LOCATION, LOC_TIME, DEBUG_INFO, DISTANCE};
    static final String[] ATTRIBUTES_DATA_TYPE = {
            ...
            REAL_DATA, INT_DATA, STRING_DATA,REAL_DATA};
     ...
     */
    static TrackerEntry createEntry(Location loc, float distFromNetLocation, int scheduleId) {
